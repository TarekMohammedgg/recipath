...
class _ImportData implements ImportData {
  const _ImportData({required  List<RecipeData> recipes, required this.groceries, required this.tagsPerRecipe, required this.tagsPerGrocery}): _recipes = recipes;
